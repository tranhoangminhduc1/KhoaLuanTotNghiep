...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/minhduc.jpg') }}" height="100" alt="MINH DUC SHOP"
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-home me-3"></i> 168 Phan Chu Trinh, Thành phố Huế - Việt Nam</p>
                        <p>
                            <i class="fas fa-envelope me-3"></i>
                            minhduc.tranhoang@gmail.com
                        </p>
                        <p><i class="fas fa-phone me-3"></i> +84 0938271942</p>
                    </div>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2024 Bản quyền thuộc về:
                    <a class="text-white" href="/">MINH DUC SHOP</a>
                </span>
            </div>
        </section>
    </footer>
